...
export const siteConfig: SiteConfig = {
	title: "秋风的小站",
	subtitle: "分享兴趣、笔记与日常思考",
	siteURL: "https://www.xuehdxz.dpdns.org/", // 请替换为你的站点URL，以斜杠结尾
	...
	navbarTitle: {
		...
		icon: "assets/home/home-1.webp",
		// 网站Logo图片路径
		logo: "assets/home/home-1.webp",
	},
	// 页面自动缩放配置
	pageScaling: {
	...
	bilibili: {
		vmid: "1129280784", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	links: [
		{
			...
			url: "https://www.xuehdxz.dpdns.org/",
		},
	],
};
...
export const musicPlayerConfig: MusicPlayerConfig = {
	enable: false, // 暂未迁移真实歌单，先关闭模板默认播放器
